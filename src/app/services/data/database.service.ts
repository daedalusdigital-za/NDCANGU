    ...
    return [
      {
        ...
        email: 'sarah.johnson@health.gov.za',
        ...
        status: 'Active',
        location: 'Cape Town',
        bio: 'Senior family physician specializing in diabetes and hypertension management'
      },
      {
        id: 2,
        ...
        status: 'Active',
        location: 'Durban',
        bio: 'Internal medicine specialist with focus on non-communicable diseases'
      },
      {
        id: 3,
        name: 'Sr. Mary Ndlovu',
        email: 'mary.ndlovu@health.gov.za',
        phone: '+27-84-345-6789',
        province: 'Gauteng',
        provinceId: 7,
        qualification: 'BSc Nursing, Diabetes Education Certificate',
        experience: 15,
        status: 'Active',
        location: 'Johannesburg',
        bio: 'Senior nursing sister specializing in diabetes education and patient counselling'
      },
      {
        id: 4,
        name: 'Dr. Ahmed Hassan',
        email: 'ahmed.hassan@health.gov.za',
        phone: '+27-85-456-7890',
        province: 'Eastern Cape',
        provinceId: 2,
        qualification: 'MBChB, Dip PEC (SA)',
        experience: 6,
        status: 'Active',
        location: 'Port Elizabeth',
        bio: 'Primary healthcare physician with expertise in preventive care'
      },
      {
        id: 5,
        name: 'Dr. Nomsa Khumalo',
        email: 'nomsa.khumalo@health.gov.za',
        ...
        status: 'Active',
        location: 'Polokwane',
        bio: 'Public health physician focusing on community health and disease prevention'
      },
      {
        id: 6,
        name: 'Pharmacist John Smith',
        email: 'john.smith@health.gov.za',
        phone: '+27-87-678-9012',
        province: 'Free State',
        provinceId: 4,
        qualification: 'BPharm, PGDip Clinical Pharmacy',
        experience: 7,
        status: 'Active',
