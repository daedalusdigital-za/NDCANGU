function getChartColorsArray(e) { 
    ...
    try {
        ...
        console.warn('Failed to parse chart colors for element:', e, error);
        return [];
    }
}
...
initializeChart("#line_chart_datalabel", lineDatalabelOptions);

// Line Chart Dashed
var lineDashedColors = getChartColorsArray("#line_chart_dashed");
var lineDashedOptions = { 
    chart: { height: 380, type: "line", zoom: { enabled: !1 }, toolbar: { show: !1 } }, 
    ...
    tooltip: { 
        y: [
            { title: { formatter: function (e) { return e + " (mins)" } } }, 
...
initializeChart("#line_chart_dashed", lineDashedOptions);
...
initializeChart("#spline_area", splineAreaOptions);
...
initializeChart("#column_chart_datalabel", columnDatalabelOptions);
...
initializeChart("#bar_chart", barOptions);
...
initializeChart("#mixed_chart", mixedOptions);
...
initializeChart("#radial_chart", radialOptions);

// Pie Chart
var pieColors = getChartColorsArray("#pie_chart");
var pieOptions = { 
    chart: { height: 320, type: "pie" }, 
    series: [44, 55, 41, 17, 18], 
    labels: ["Mpumalanga", "Eastern Cape", "Gauteng", "Free State", "Kwazulu-Natal"], 
    colors: pieColors, 
    legend: { 
        show: !0, 
        position: "bottom", 
...
initializeChart("#pie_chart", pieOptions);
...
initializeChart("#donut_chart", donutOptions);